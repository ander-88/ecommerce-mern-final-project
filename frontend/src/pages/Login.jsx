...
useEffect(()=>{
  ...
  return (
    <form onSubmit={onsubmitHandler} className='flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800'>
      ...
      <button className='bg-black text-white font-light px-8 py-2 mt-4 cursor-pointer hover:bg-yellow-400 hover:text-black'>{currentState === 'Login' ? 'Sign In' : 'Sign Up'}</button>
    </form>
  )
}
